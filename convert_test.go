...
func TestConvert(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotS, gotErr := Convert(tt.args.offset, tt.args.buf, tt.args.n, tt.args.width, tt.args.group, tt.args.format, tt.args.reverse)
			if gotErr != nil {
